...
const Skills = () => {
    ...
    return (
        <section className='wide:max-w-[1500px] desktop:max-w-[1300px] laptop:max-w-[1100px] tablet:max-w-[700px] mobile:max-w-[500px] max-w-[380px] flex flex-col justify-center items-center w-full gap-[50px]'>
